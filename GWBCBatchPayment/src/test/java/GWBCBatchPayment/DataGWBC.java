...
public class DataGWBC {
	...
	public ArrayList<String> getData(String testcaseName) throws IOException
	{
		//fileInputStream argument
				...
				File file = new File ("C:\\GW Automation Scripts\\GWBCBatchPayment\\GWBC_Data_PaymentBatch.xlsx");
				...
				for (int i=0; i<sheets; i++)
				{
					...
					{
						Cell value = ce.next();
						if(value.getStringCellValue().equalsIgnoreCase("GWBC"))
					{
						column=k;
					}
						k++;
